$(function () {
  ...
  function setup() {
    ...
    createCollectable("steve", 500, 230, 20, 0.5);
    createCollectable("grace", 1060, 600);
    createCollectable("max", 170, 600);
